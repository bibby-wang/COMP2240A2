...
class c3214157A2P1{
	public static void main(String[] args) {
		...
		for(int i=1; i <= NumS; i++){
			new Thread(threadFamer,"S_Farmer" + i ).start(); // Create and initialize the threadFamer type object of South Farmers
		}
		for(int i=1; i <= NumN; i++){
			new Thread(threadFamer,"N_Farmer" + i ).start(); // Create and initialize the threadFamer type object of North Farmers
		}		
